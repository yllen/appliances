...
if(strpos($_SERVER['PHP_SELF'],"dropdownapplicatifs.php")){
	define('GLPI_ROOT', '../../..');
	$AJAX_INCLUDE=1;
...
$where=" WHERE (glpi_plugin_applicatifs.type = '".$_POST['type_applicatifs']."') 
		AND glpi_plugin_applicatifs.deleted='0'";

if (isset($_POST["entity_restrict"])&&$_POST["entity_restrict"]>=0){
	$where.=getEntitiesRestrictRequest("AND","glpi_plugin_applicatifs",'',$_POST["entity_restrict"],true);
} else {
	$where.=getEntitiesRestrictRequest("AND","glpi_plugin_applicatifs",'','',true);
}
...
if ($_POST['searchText']!=$CFG_GLPI["ajax_wildcard"])
	$where.=" AND glpi_plugin_applicatifs.name ".makeTextSearch($_POST['searchText']);
